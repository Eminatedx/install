...
sudo ./meson_cdn config set --token=douobqmfdfazlwfoendqwdwh  --https_port=443 --cache.size=30
...
./app status
sleep 20
sudo ./apps/gaganode/gaganode config set --token=sxbudmozbtcrdwfyemrgqyzm
./app restart
